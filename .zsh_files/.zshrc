...
# THIS IS MINE ZSH STYLE
# EDIT p10k.zsh!!!

# THIS ADD ALL MINE FUNCTIONS
source ~/.zsh/my_functions/my_functions.zsh

# THIS ARE MINE ALIAS
alias gcl='git clone'
alias push='git add . && git commit -m "update" && git push'
alias norm="norminette -R CheckForbiddenSourceHeader CheckDefine"
alias norminette+="python3 ~/norminette+/run.py"
